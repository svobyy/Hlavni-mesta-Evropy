...
# -----------------------------------------------------------------
body = 0  # počet zodpovězených otázek
pocet = 42  # celkový počet otázek
# -----------------------------------------------------------------
...
x = open('C:/tvoje_skore/vysledek.txt', 'w')
# -----------------------------------------------------------------


# zápis do souboru

with open("C:/tvoje_skore/vysledek.txt", "w") as text_file:
...
print('Na disku C: v adresáři tvoje_skore máš soubor vysledek.txt')
